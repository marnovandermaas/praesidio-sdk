...
On Ubuntu 20.04 you will encounter an error asking you to port `freadahead.c` and `fseeko.c` to your platform, this is because of an update in glibc from Ubuntu 18 to 20. You can fix the error by applying [this patch](https://github.com/coreutils/gnulib/commit/4af4a4a71827c0bc5e0ec67af23edef4f15cee8e) and then running `make` again.
